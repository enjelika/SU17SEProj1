...
{
	private JButton saveButton, backButton, cancelButton, findButton, logoutButton;
	private JLabel imageFrame, courierBonusValue;
    ...
    public EditDeliveryTicketScreen(ButtonController buttonController)
    {
    	 ...
    	 */    	   	
    	// Cancel Button
    	Image cancelButtonIcon = Utility.getImage(filePath + separator + "images" + separator + "cancelButton.png");
    	cancelButton = new JButton(new ImageIcon(cancelButtonIcon));
    ...
    public void SetUpView()
    {
	    ...
	    // Container Bonus --space-- Save buttons
	 	...
	 	bonusAndSaveButtonContainer.setBorder(new EmptyBorder(25, 25, 5, 25));
		 	...
		 	courierBonusValue.setBorder(new EmptyBorder(0, 0, 0, 75));  
		 	bonusAndSaveButtonContainer.add(courierBonusValue);
		 	
		 	// -- Cancel Button
		 	cancelButton.setName("cancelTicket");
		 	cancelButton.setOpaque(false);
		 	cancelButton.setContentAreaFilled(false);
		 	saveButton.setBorder(new EmptyBorder(0, 0, 0, 20));
		 	saveButton.addActionListener(editDeliveryTicketController);
		 	bonusAndSaveButtonContainer.add(cancelButton);
