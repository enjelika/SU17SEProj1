...
public class CreateDeliveryTicketScreen2 extends JPanel
{
	private JButton saveButton, backButton, logoutButton;
	private JLabel imageFrame, pickUpCustomerValue, deliveryCustomerValue, courierBonusValue;
	private JPanel ticketScreen2Container, southButtonContainer, mainPane, imgContainer;
    ...
    private ButtonController deliveryTicket2Controller;
    
    public CreateDeliveryTicketScreen2(ButtonController buttonController)
    {
    	deliveryTicket2Controller = buttonController;
    	...
    	ticketScreen2Container = new JPanel();
    	Border border = new LineBorder(Color.BLUE, 1);
    	Border margin = new EmptyBorder(0, 0, 0, 0);
    	ticketScreen2Container.setBorder(new CompoundBorder(margin, border));
    	ticketScreen2Container.setAlignmentY(CENTER_ALIGNMENT);
    ...
    public void SetUpView()
    {
		...
		// Screen Title: Delivery Ticket  --space-- Date --space-- Time
		...
		// Pick Up Customer --space-- Delivery Customer
		...
		subtitleContainer.setLayout(new FlowLayout(FlowLayout.LEFT));	
			...
			JLabel pickUpCustomerLabel = new JLabel("Pick Up Customer: ");
			pickUpCustomerLabel.setFont(new Font("Calibri", Font.PLAIN, 26));
			pickUpCustomerLabel.setBorder(new EmptyBorder(0, 0, 0, 0));
			pickUpDeliveryInfoSubtitle.add(pickUpCustomerLabel);
			
			pickUpCustomerValue = new JLabel();
			// TODO: pickUpCustomerValue = deliveryTicket2Controller.model.getPickUpCustomerName();
			pickUpCustomerValue.setText("test1");
			pickUpCustomerValue.setFont(new Font("Calibri", Font.PLAIN, 26));
			pickUpCustomerValue.setBorder(new EmptyBorder(0, 0, 0, 0));
			pickUpDeliveryInfoSubtitle.add(pickUpCustomerValue);
			
			JLabel deliveryCustomerLabel = new JLabel("Delivery Customer: ");
			deliveryCustomerLabel.setFont(new Font("Calibri", Font.PLAIN, 26));
			deliveryCustomerLabel.setBorder(new EmptyBorder(0, 0, 0, 0));
			pickUpDeliveryInfoSubtitle.add(deliveryCustomerLabel);
			
			deliveryCustomerValue = new JLabel();
			// TODO: deliveryCustomerValue = deliveryTicket2Controller.model.getDeliveryCustomerName();
			deliveryCustomerValue.setText("test2");
			deliveryCustomerValue.setFont(new Font("Calibri", Font.PLAIN, 26));
			deliveryCustomerValue.setBorder(new EmptyBorder(0, 0, 0, 0));
			pickUpDeliveryInfoSubtitle.add(deliveryCustomerValue);
		 ...
		 */
		ticketScreen2Container.setLayout(new BoxLayout(ticketScreen2Container, BoxLayout.Y_AXIS));
		ticketScreen2Container.setOpaque(false);
		...
		ticketScreen2Container.add(ticketPackageID);
		...
		ticketScreen2Container.add(courierNameCbContainer);
		...
		ticketScreen2Container.add(estBlocksAndDeliveryTimeContainer);
		...
		ticketScreen2Container.add(outerBoxLayoutXaxisContainer);
	    ...
	    // Container Bonus --space-- Save buttons
	 	...
	 	bonusAndSaveButtonContainer.setBorder(new EmptyBorder(25, 25, 5, 25));
		 	...
		 	// Courier Bonus Labels
		 	JLabel courierBonusLabel = new JLabel("Courier Bonus: ");
		 	courierBonusLabel.setFont(new Font("Calibri", Font.PLAIN, 24));
		 	courierBonusLabel.setBorder(new EmptyBorder(0, 0, 0, 25));
		 	bonusAndSaveButtonContainer.add(courierBonusLabel);
		 	
		 	// Add Courier Bonus TextField (non-editable)
		 	courierBonusValue = new JLabel("<auto-generated>");
		 	courierBonusValue.setFont(new Font("Calibri", Font.PLAIN, 24));
		 	courierBonusValue.setBorder(new EmptyBorder(0, 0, 0, 300));  
		 	bonusAndSaveButtonContainer.add(courierBonusValue);
		    ...
		    // -- Save Button
		 	...
		 	saveButton.addActionListener(deliveryTicket2Controller);
		 	bonusAndSaveButtonContainer.add(saveButton);
	 	
	 	ticketScreen2Container.add(bonusAndSaveButtonContainer);

		// --- end of Box for Menu buttons
			 	
	 	overallTicketContainer.add(ticketScreen2Container);
		 ...
		 */
        // -- Back Button
		backButton.setName("ticketBackButton");
		backButton.setOpaque(false);
		backButton.setContentAreaFilled(false);
		backButton.setBorder(new EmptyBorder(0, 0, 0, 210));
		backButton.addActionListener(deliveryTicket2Controller);
		...
		logoutButton.addActionListener(deliveryTicket2Controller);
